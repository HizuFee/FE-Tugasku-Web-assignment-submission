    ...
    <head>
        ...
        <title>Blank - TugasKu Dashboard</title>
        <link
                ...
                <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
                    <div
                        ...
                        <ul class="flex items-center flex-shrink-0 space-x-6">
                            ...
                            <li class="flex">
                                <button
                                    class="rounded-md focus:outline-none focus:shadow-outline-purple transition duration-300"
                                    @click="toggleTheme"
                                    aria-label="Toggle color mode">
                                    <template x-if="!dark">
                                        <svg
                                            class="w-5 h-5 transition duration-300 ease-in-out transform"
                                            aria-hidden="true"
                                            fill="currentColor"
                                            viewBox="0 0 20 20">
                                    ...
                                    <template x-if="dark">
                                        <svg
                                            class="w-5 h-5 transition duration-300 ease-in-out transform rotate-180"
                                            aria-hidden="true"
                                            fill="currentColor"
                                            viewBox="0 0 20 20">
                            ...
                            <div class="relative">
                                <button
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <!-- User name -->
                                        <span class="ml-3 mr-3 text-sm font-medium text-gray-700 dark:text-gray-200">
