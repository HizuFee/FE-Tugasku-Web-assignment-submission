                    ...
                    <div class="w-full">
                        ...
                        <form action="/register" method="POST" class="space-y-4">
                            <label class="block text-sm">
                                ...
                                <input
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:placeholder-gray-500 dark:focus:shadow-outline-gray form-input"
